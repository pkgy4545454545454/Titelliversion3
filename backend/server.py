...
@api_router.get("/demande-inscriptions")
async def list_registration_requests(
    ...
    query = {}  # filtre
    projection = {"_id": 0}  # champs à exclure/afficher

    cursor = db.registration_requests.find(query, projection).skip(skip).limit(limit)
