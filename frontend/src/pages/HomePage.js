    ...
    <div className="min-h-screen bg-white" data-testid="home-page">
      ...
      <section className="relative h-[70vh] overflow-hidden" data-testid="hero-section">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-left px-4">
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-black  mb-8 animate-fade-in drop-shadow-lg" style={{ fontFamily: 'Playfair Display, serif', textAlign: 'center' }}>
          ...
          <div className="flex flex-col items-start gap-1 animate-fade-in stagger-2">
            ...
            <div className="flex flex-wrap justify-start gap-2" style={{ fontFamily: 'Playfair Display, serif', textAlign: 'center' }}>
              {[
