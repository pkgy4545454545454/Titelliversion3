...
export const demandeInscriptionAPI = {
  list: (params) => axios.get(`${API}/demande-inscriptions`, { params: { limit: 500, ...params } }),
  get: (id) => axios.get(`${API}/demande-inscriptions/${id}`),
  getById: (id) => axios.get(`${API}/demande-inscriptions/${id}`),
  create: (data) => axios.post(`${API}/demande-inscriptions`, data, { headers: getAuthHeaders() }),
  update: (id, data) => axios.put(`${API}/demande-inscriptions/${id}`, data, { headers: getAuthHeaders() }),
};
